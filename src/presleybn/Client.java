...
public class Client {
	...
	private void start() {
		try {
			...
			socket = null;
			System.gc();
			System.out.println("FATAL: Failed for unknown reasons. Quitting...");
			System.exit(1);
		}
	}
		...
		public void run() {
			...
			while(true) {
				try {
					...
					System.out.println("WARN: Failed to start DDoS attack, stopping Thread!");
					break;
				}
			}
		}
